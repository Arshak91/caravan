...
class Marker extends BaseService {
    constructor() {
        super();
    }
    ...
    getMarker = (data) => {
        let { width, height, isSelected, color, index } = data
        const widthh = width ? width : 28;
        const heightt = height ? height : 48;
        let markerBgColor = isSelected ? '#707070' : '#FFFFFF';
        let textColor = isSelected ? '#FFFFFF' : '#707070';
        const colors = color ? '#' + color : false;
        ...
        <svg width="${widthh}" height="${heightt}" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <g id="Group_1907" transform="translate(-15201.009 -831.61)">
            ...
            <text transform="matrix(1 0 0 1 15213.0029 851.5743)" class="st2 st3 st4">${ index ? index : '' }</text>
        </g>
        </svg>`;
        return text;
        // res.writeHead(200, {'Content-Type': 'image/svg+xml'});
    ...
    getUnplannedMarker = (data) => {
        const width = data.width ? data.width : 100;
        const height = data.height ? data.height : 69;
        const bgColor = data.bgColor ? data.bgColor : '#707070'
        const markerBgColor = data.isSelected ? '#' + bgColor : '#FFFFFF';
        const borderColor = data.isSelected ? 'transparent' : 'red';
        const textColor = data.isSelected ? '#FFFFFF' : 'red';
        ...
        <svg width="${width}" height="${height}" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 94.7 64.9" style="enable-background:new 0 0 94.7 64.9;" xml:space="preserve">
            ...
            <g>
                ...
                <text transform="matrix(1 0 0 1 38.0157 19.651)" class="st1 st3 st5">ID ${ data.orderId ? data.orderId : '' }</text>
            </g>
        </svg>
        `;
        return text;
    ...
    getPlannedMarker = (data) => {
        const width = data.width ? data.width : 28;
        const height = data.height ? data.height : 48;
    ...
    getEventMarker = (data) => {
        const width = data.width ? data.width : 15;
        const height = data.height ? data.height : 15;
        const markerBgColor = data.bgColor ? data.bgColor : '000000';
    ...
    getDeliveryTruckMarker = (data) => {
        const width = data.width ? data.width : 25;
    ...
    getDepotMarker = (data) => {
        const text = `<?xml version="1.0" encoding="utf-8"?>
                ...
                <g>
                <g>
                <path d="M256,0C150.1,0,64,86.1,64,192c0,133.1,173.3,307.9,180.7,315.3c3.1,3.1,7.2,4.7,11.3,4.7c4.1,0,8.2-1.6,11.3-4.7
                C274.7,499.9,448,325.1,448,192C448,86.1,361.9,0,256,0z"/>
                </g>
                </g>
                <path class="st0" d="M335.2,163.1c-1.9,5.3-6.9,8.9-12.6,8.9h-13.3v66.6c0,7.4-6,13.3-13.3,13.3h-80c-7.4,0-13.3-6-13.3-13.3V172
                h-13.3c-5.7,0-10.7-3.6-12.6-8.9c-1.9-5.3-0.2-11.3,4.3-14.8L247.7,95c4.9-3.9,11.8-3.9,16.7,0l66.6,53.3
                C335.4,151.8,337.1,157.8,335.2,163.1z"/>
                </svg>
    `;
        return text;
        // res.writeHead(200, {'Content-Type': 'image/svg+xml'});
    ...
    // mainMarker = {
    //     ['selected']: () => (`<?xml version="1.0" encoding="UTF-8"?>
    //     <svg
    //         xmlns="http://www.w3.org/2000/svg"
    //         xml:space="preserve"
    //         width="0.864437in"
    ...
    // get markerModel () {
	// 	return this.mainMarker[this.type]
	// }
    //     ['else']: () => (`<?xml version="1.0" encoding="UTF-8"?>
    //     <svg
    //         xmlns="http://www.w3.org/2000/svg"
